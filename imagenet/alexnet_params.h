...
static const elem_t conv_3_w[2304][256] row_align(1);
static const acc_t conv_3_b[256] row_align_acc(1);
static elem_t conv_3_in row_align(1); 
static elem_t conv_3_out[4][13][13][256] row_align(1);
...
static const acc_t fc_6_b[4][4096] row_align_acc(1)
...
static const acc_t fc_7_b[4][4096] row_align_acc(1)
...
static const acc_t fc_9_b[4][1000] row_align_acc(1)
